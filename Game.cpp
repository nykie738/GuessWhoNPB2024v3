...
Game::Game() : window(sf::VideoMode(W_WIDTH, W_HEIGHT), "Guess the Baseball Player!"),
...
void Game::handleSelection()
{
    ...
    hanshinB.setPosition(W_WIDTH / 2.0f, 230);
    ...
    hanshinT.setPosition(W_WIDTH / 2.0f, 230);
    ...
    giantsB.setPosition(W_WIDTH / 2.0f, 150);
    ...
    giantsT.setPosition(W_WIDTH / 2.0f, 150);
    ...
    bayB.setPosition(W_WIDTH / 2.0f, 310);
    ...
    bayT.setPosition(W_WIDTH / 2.0f, 310);
    ...
    carpB.setPosition(W_WIDTH / 2.0f, 390);
    ...
    carpT.setPosition(W_WIDTH / 2.0f, 390);
    ...
    swallowsB.setPosition(W_WIDTH / 2.0f, 470);
    ...
    swallowsT.setPosition(W_WIDTH / 2.0f, 470);
    ...
    dragonsB.setPosition(W_WIDTH / 2.0f, 550);
    ...
    dragonsT.setPosition(W_WIDTH / 2.0f, 550);
...
void Game::handleGuessing()
{
    ...
    playerSprite.setPosition(300, 135);
    ...
    dareda.setPosition(W_WIDTH / 2.0f, 50);
    ...
    mouikkai.setPosition(W_WIDTH / 2.0f, 50);
...
void Game::handleCorrect()
{
    ...
    nextButton.setPosition(W_WIDTH / 2.0f, 870);
    ...
    nextText.setPosition(W_WIDTH / 2.0f, 870);
...
void Game::handleIncorrect()
{
    ...
    sf::Text answer("Incorrect! The correct player is:", font, 50);
    answer.setFillColor(sf::Color::Yellow);
    answer.setPosition(W_WIDTH / 2.0f, 30);
    answer.setOrigin(answer.getLocalBounds().width / 2.0f, answer.getLocalBounds().height / 2.0f);

    sf::Text answerName(wrongPlayer->getName(), font, 50);
    answerName.setFillColor(sf::Color::Yellow);
    answerName.setPosition(W_WIDTH / 2.0f, 80);
    answerName.setOrigin(answerName.getLocalBounds().width / 2.0f, answerName.getLocalBounds().height / 2.0f);
...
void Game::handleComplete()
{
    ...
    sf::Text answer("That's it! Thank you for playing!", font, 50);
    answer.setFillColor(sf::Color::Yellow);
    answer.setPosition(W_WIDTH / 2.0f, 30);
    answer.setOrigin(answer.getLocalBounds().width / 2.0f, answer.getLocalBounds().height / 2.0f);

    sf::Text score("Your score is " + std::to_string(userpoints) + "/24 !", font, 50);
    score.setFillColor(sf::Color::Yellow);
    score.setPosition(W_WIDTH / 2.0f, 160);
    score.setOrigin(score.getLocalBounds().width / 2.0f, score.getLocalBounds().height / 2.0f);

    sf::Text outstanding("You must be a big fan of ", font, 50);
    outstanding.setFillColor(sf::Color::Yellow);
    outstanding.setPosition(W_WIDTH / 2.0f, 260);
    outstanding.setOrigin(outstanding.getLocalBounds().width / 2.0f, outstanding.getLocalBounds().height / 2.0f);
    sf::Text outstanding2(selectedTeam + "!", font, 50);
    outstanding2.setFillColor(sf::Color::Yellow);
    outstanding2.setPosition(W_WIDTH / 2.0f, 330);
    outstanding2.setOrigin(outstanding2.getLocalBounds().width / 2.0f, outstanding2.getLocalBounds().height / 2.0f);

    sf::Text end("Press enter to end the game.", font, 50);
    end.setFillColor(sf::Color::Yellow);
    end.setPosition(W_WIDTH / 2.0f, 420);
